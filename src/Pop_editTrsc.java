...
public class Pop_editTrsc {
    public JFrame frame = new JFrame("Edit Transaction");
    ...
    public Object[][] targetTransaction;

    public String customerID, firstName, lastName;
    public Pop_editTrsc(String transactionID){
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        this.transactionID = transactionID;
        String queryString;

        queryString = "select * from detailed_transaction WHERE transactionID = '" + transactionID + "'";
        targetTransaction = DB_CRUD.searchTransaction(queryString);
        customerID = (String) targetTransaction[0][4];
        firstName = (String) targetTransaction[0][5];
        lastName = (String) targetTransaction[0][6];
        dateD = (String) targetTransaction[0][3];
        dateM = (String) targetTransaction[0][2];
        dateY = (String) targetTransaction[0][1];
        serviceID = (String) targetTransaction[0][7];
        serviceName = (String) targetTransaction[0][8];
        servicePrice = (String) targetTransaction[0][10];
        cardID = (String) targetTransaction[0][11];
        cardCover = (String) targetTransaction[0][13];
        cashPayment = (String) targetTransaction[0][14];
    ...
    public void constTrscTimePanel(){
        ...
        dayCB[0] = (String) targetTransaction[0][3];
        monthCB[0] = (String) targetTransaction[0][2];
        yearCB[0] = (String) targetTransaction[0][1];
        for (int i = 1; i < 32; i++){
...
//        pnlMediCard = new JPanel(null);
    ...
    public void constPreviewPanel(){
        ...
        // @ToDo: need to change call updateTransaction from DB_CRUD
...
//                System.out.println(transaction.cashPayment);
        ...
        btnClearForm.addActionListener(e -> frame.dispose());
        ...
        btnUpdateTransaction.setBounds(0,400,140,30);
        ...
        pnlPreview.add(btnUpdateTransaction);
